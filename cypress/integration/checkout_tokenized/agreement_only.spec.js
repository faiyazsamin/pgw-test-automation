...
describe('Tokenized Checkout Agreement', () => {
    before(() => {
        cy.request('POST', 'https://pgwdemosite.com/create', {"payerReference":"01770618576","callbackURL": Cypress.env('callbackURL'),"mode":"0000"}).as('create_payment_resp').then((response) => {
    ...
    describe('Tokenized Checkout Wallet Page', () => {
        ...
        it('Check if the page has proper title', () => {
            ...
            .and('eq', Cypress.env('page_title_0000'))
        });
    ...
    describe('Tokenized Checkout OTP Page', () => {
        ...
        it('Check if providing correct OTP takes user to agreement confirmation page', () => {
